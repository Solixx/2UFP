  ...
  /*************************************************************************
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        int mykeys[] = new int[]{6,3,9,10,1,5};
    ...
    private void posorder(Node x, Queue<Key> queue){
        if  (x == null)   return;
        posorder(x.left, queue);
        posorder(x.right, queue);
        queue.enqueue(x.key);
    }
    ...
    private int contaFolhas(Node x){
        if  (x == null)   return 0;
        else if (x.left == null && x.right == null) return 1;
        else {
            return contaFolhas(x.left) + contaFolhas(x.right);
        }
    }
